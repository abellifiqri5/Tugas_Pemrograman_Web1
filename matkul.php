...
<body class="bg-light">
    ...
    <div class="container my-4">
        <ul class="nav nav-tabs mb-4">
            ...
            <li class="nav-item"><a class="nav-link active" href="matkul.php">Mata Kuliah</a></li>
            ...
            <div class="modal-content">
                ...
                <form id="formMatkul" onsubmit="simpanMatkul(event)">
                    <div class="modal-body">
                        ...
                        <div class="mb-3"><label>Kode MK</label><input type="text" class="form-control" id="kode_matkul" name="kode_matkul" required></div>
                        <div class="mb-3"><label>Nama Mata Kuliah</label><input type="text" class="form-control" id="nama_matkul" name="nama_matkul" required></div>
                        <div class="mb-3"><label>SKS</label><input type="number" class="form-control" id="sks" name="sks" required></div>
                    </div>
